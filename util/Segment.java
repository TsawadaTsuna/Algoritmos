...
public class Segment implements Comparable<Segment> {
    ...
    public Segment(int id,Point2D v, Point2D w) {
        if (id<-1) throw new IllegalArgumentException("id should be grater than -1");
    ...
    public static void main(String[] args) {
        Segment e = new Segment(0,new Point2D(7.0, 7.0), new Point2D(5.0, 7.0));
        StdOut.println(e);
        StdOut.println(e.isSinglePoint());
    }
}
