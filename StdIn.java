...
public final class StdIn {
    ...
    public static void main(String[] args) {
        ...
        util.StdOut.print("Type a string: ");
        String s = StdIn.readString();
        util.StdOut.println("Your string was: " + s);
        util.StdOut.println();

        util.StdOut.print("Type an int: ");
        int a = StdIn.readInt();
        util.StdOut.println("Your int was: " + a);
        util.StdOut.println();

        util.StdOut.print("Type a boolean: ");
        boolean b = StdIn.readBoolean();
        util.StdOut.println("Your boolean was: " + b);
        util.StdOut.println();

        util.StdOut.print("Type a double: ");
        double c = StdIn.readDouble();
        util.StdOut.println("Your double was: " + c);
        util.StdOut.println();
    }
